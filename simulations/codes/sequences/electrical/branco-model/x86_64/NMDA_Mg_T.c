...
#define rmb _p[4]
#define rmb_columnindex 4
#define rmu _p[5]
#define rmu_columnindex 5
#define rbMg _p[6]
#define rbMg_columnindex 6
#define rmc1b _p[7]
#define rmc1b_columnindex 7
#define rmc1u _p[8]
#define rmc1u_columnindex 8
#define rmc2b _p[9]
#define rmc2b_columnindex 9
#define rmc2u _p[10]
#define rmc2u_columnindex 10
#define U _p[11]
#define U_columnindex 11
#define Cl _p[12]
#define Cl_columnindex 12
#define D1 _p[13]
#define D1_columnindex 13
#define D2 _p[14]
#define D2_columnindex 14
#define O _p[15]
#define O_columnindex 15
#define UMg _p[16]
#define UMg_columnindex 16
#define ClMg _p[17]
#define ClMg_columnindex 17
#define D1Mg _p[18]
#define D1Mg_columnindex 18
#define D2Mg _p[19]
#define D2Mg_columnindex 19
#define OMg _p[20]
#define OMg_columnindex 20
#define DU _p[21]
#define DU_columnindex 21
#define DCl _p[22]
#define DCl_columnindex 22
#define DD1 _p[23]
#define DD1_columnindex 23
#define DD2 _p[24]
#define DD2_columnindex 24
#define DO _p[25]
#define DO_columnindex 25
#define DUMg _p[26]
#define DUMg_columnindex 26
#define DClMg _p[27]
#define DClMg_columnindex 27
#define DD1Mg _p[28]
#define DD1Mg_columnindex 28
#define DD2Mg _p[29]
#define DD2Mg_columnindex 29
#define DOMg _p[30]
#define DOMg_columnindex 30
#define _g _p[31]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 NMDA_Mg_T /home/bhanu/work/bhalla_lab_github/synaptic-convergence-paper/simulations/codes/sequences/electrical/branco-model/mod.files/NMDA_Mg_T.mod\n");
 ...
 t = 0.0;
{
 ...
 if(error){fprintf(stderr,"at line 180 in file NMDA_Mg_T.mod:\n  SOLVE kstates STEADYSTATE sparse \n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 10; ++_i) {
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 185 in file NMDA_Mg_T.mod:\n\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 10; ++_i) {
      _p[_slist1[_i]] += dt*_p[_dlist1[_i]];
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/bhanu/work/bhalla_lab_github/synaptic-convergence-paper/simulations/codes/sequences/electrical/branco-model/mod.files/NMDA_Mg_T.mod";
static const char* nmodl_file_text = 
