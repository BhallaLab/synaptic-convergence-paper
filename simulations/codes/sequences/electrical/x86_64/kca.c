...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kca /home/bhanu/work/network-connectivity/simulations/codes/sequences/electrical/mod.files/kca.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/bhanu/work/network-connectivity/simulations/codes/sequences/electrical/mod.files/kca.mod";
static const char* nmodl_file_text = 
  "\n"
  "COMMENT\n"
