...
def plot_activation_data(net, M, num_patterns, activation_type, ax):
    ...
    for neuron in range(pscsd_neurons_activation_data.shape[1]):
        ax[9].plot(
...
def main():
    ...
    figure.suptitle("Hippo-CICR, 4 ensembles, sequence length=4")
    plt.savefig("Figure-7.png", bbox_inches="tight")
    plt.savefig("Figure-7.svg", bbox_inches="tight")
